...
POSSIBLE_TEAMS = {											-- possible team names & base colors. This list will be shuffled.
	{"Road Markings",255,255,255,"#FFFFFF"}, --white
	{"Team Oil",0,0,0,"#000000"}, -- black
	{"Team Tail Light",255,0,0,"#FF0000"}, -- red
	{"Going Offroad",0,255,0,"#00FF00"}, -- green
	{"The Windshield Washers",0,0,255,"#0000FF"}, -- blue
	{"Team Xenon",0,255,255,"#00FFFF"}, -- cyan
	{"Lavender Freshened Car Interior",255,0,255,"#FF00FF"}, -- magenta
	{"Team Turn Signal",255,255,0,"#FFFF00"} -- yellow
}
