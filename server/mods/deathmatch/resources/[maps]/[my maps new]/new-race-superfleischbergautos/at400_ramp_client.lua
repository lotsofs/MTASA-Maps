...
function hideRamps()
    ...
    setElementPosition(AT_RAMPS[6], -54.1, -206.60001, -35.8)
    setElementPosition(AT_RAMPS[7], -63.9, -192, -39.2)
    setElementPosition(AT_RAMPS[8], -15.6, -199.8, -50.2)
    setElementPosition(AT_RAMPS[9], -48.9, -204.10001, -36.8)
...
function showRamps()
    ...
    setElementPosition(AT_RAMPS[6], -54.1, -206.60001, 5.8)
    setElementPosition(AT_RAMPS[7], -63.9, -192, -9.2)
    setElementPosition(AT_RAMPS[8], -15.6, -199.8, -20.2)
    setElementPosition(AT_RAMPS[9], -48.9, -204.10001, 6.8)
...
function erectAtHelperRamp(element, matchingDimension)
	...
	-- end
    if (vehicle == 577 and not AT_TUTORIAL_SHOWN) then -- at400
        showRamps()
