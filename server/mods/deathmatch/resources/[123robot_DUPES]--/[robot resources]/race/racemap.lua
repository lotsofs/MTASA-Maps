g_MapObjAttrs = {
	...
	checkpoint = { 'id', 'nextid', 'position', 'size', 'color', 'type', 'vehicle', 'paintjob', 'upgrades', 'blipsize' },
...
g_MapSettingNames = table.create(
	{'time', 'weather', 'respawn', 'respawntime', 'duration', 'skins', 'bikehats', 'bikehatchance', 'carhats', 'carhatchance',
	 ...
	 'countdownduration', 'timeafterfirstfinish'},
	true
)
...
function RaceElementMap:getAll(name, type)
	...
	if name == "object" then
		...
		return #getElementsByType(name, resRoot)
